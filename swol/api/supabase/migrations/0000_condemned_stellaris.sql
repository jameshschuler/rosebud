...
CREATE TABLE "gym_checkin" (
	...
	"activity_id" bigint DEFAULT '1' NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "gym_checkin" ADD CONSTRAINT "gym_checkin_activity_id_fkey" FOREIGN KEY ("activity_id") REFERENCES "public"."activity"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
